# data: subject male age_yr weight_kg indication qt_prolonging_drug_ongoing subj time dsubj dtime damt pk_conc pk_lloq esubj etime ecg_y qt_w tsubj ttime_h tgi_t T0_data tgi_y
begin
...
log_F = linear_pk_log_f(pk_sched; k = 5)
        pk_loc ~ kernel(pk_conc, ecg_y, tgi_y, pk_lloq, qt_w, tgi_t,
                log_Vc, log_k10, log_k12, log_k21, log_ka, qt_base, qt_slope, log_tgi_kg, log_tgi_kd, tgi_ly0, tgi_baseline_time;
                subjects = kernel_nsub_pk_loc) do yy, qq, tt, pk_lloq,
                qt_weight, tgi_t, subject_Vc, subject_k10, subject_k12, subject_k21, subject_ka, qbase, qslope, tgi_g, tgi_k, tgi_b0, tgi_t0
