...
"""
evaluate_rate_4_source(; model_only::Bool = false) = _evaluate_ppl_source(RATE_4_SOURCE, @__MODULE__; bindings = (:RATE4_N, :RATE4_K), model_only)
const _RATE_4_GRAPH_TEMPLATE = Ref{KernelSpec}()
__init__() = (_RATE_4_GRAPH_TEMPLATE[] = evaluate_rate_4_source(; model_only = true).model; nothing)
