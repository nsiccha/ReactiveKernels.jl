...
"""
evaluate_rate_5_source(; model_only::Bool = false) = _evaluate_ppl_source(RATE_5_SOURCE, @__MODULE__; bindings = (:RATE5_N1, :RATE5_N2, :RATE5_K1, :RATE5_K2), model_only)
const _RATE_5_GRAPH_TEMPLATE = Ref{KernelSpec}()
__init__() = (_RATE_5_GRAPH_TEMPLATE[] = evaluate_rate_5_source(; model_only = true).model; nothing)
