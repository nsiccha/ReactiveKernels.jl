...
@testset "DAG visualization" begin
    ...
    @test occursin("data-rk-stage", html)
    @test occursin("data-rk-fallback", html)
    @test occursin("data-rk-model", html)
    @test occursin("data-rk-picker", html)
    ...
    @test occursin("Cytoscape · ELK", html)
    @test occursin("cytoscape@3.33.4", html)
    @test occursin("elkjs@0.9.3", html)
    @test occursin("name:'elk'", html)
    @test !occursin("const rawBox", html)
