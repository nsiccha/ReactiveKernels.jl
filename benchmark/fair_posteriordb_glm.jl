...
const _INNER = "RK_FAIR_POSTERIORDB_GLM_INNER"
const _BODY = joinpath(@__DIR__, "fair_posteriordb_glm_body.jl")

function _run_pinned_comparison()
    root = normpath(joinpath(@__DIR__, ".."))
    mktempdir(prefix = "reactivekernels-fair-posteriordb-glm-") do environment
