...
const CORPUS = (
    ...
    (
        ...
        current_reactive_sources = ("packages/ReactiveKernelsCompatibilityExamples/src/preexisting_reactivehmc.jl", "examples/nuts_runtime/hmc.jl"),
    ...
    (
        ...
        current_reactive_sources = ("packages/ReactiveKernelsKernelExamples/src/hmc.jl",),
    ...
    (
        ...
        current_reactive_sources = ("benchmark/reactivehmc_statistics_kernel_fixture.jl",
                                    "examples/nuts_runtime/reactive_nuts.jl"),
