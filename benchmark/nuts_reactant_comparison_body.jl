...
function run_benchmark()
    ...
    receipt = Dict{String,Any}(
        ...
        "protocol" => Dict(
            ...
            "candidate_selection" =>
                "first N candidates with tolerance-bounded floating phase/diagnostic parity and exact control/random-consumption parity; screening is outside timing",
            "candidate_bundles_examined" => candidates_examined,
            "candidate_bundles_rejected" => candidates_rejected,
            "floating_parity_absolute_tolerance" => 128eps(Float64),
            "floating_parity_relative_tolerance" => 0.0,
            "control_and_random_consumption_parity" => "exact",
            "timing" =>
        ...
        "acceptance" => Dict(
            ...
            "per_transition_tolerance_bounded_phase_diagnostic_parity" => true,
            "exact_control_and_random_consumption_parity" => true,
