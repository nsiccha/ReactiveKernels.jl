...
# Fair all-sides benchmark on posteriordb models, batch 3 (Rate_1 beta-binomial, eight_schools hierarchical-normal).
#
...
const _INNER = "RK_FAIR_POSTERIORDB_B3_INNER"
const _BODY = joinpath(@__DIR__, "fair_posteriordb_b3_body.jl")

function _run_pinned_comparison()
    root = normpath(joinpath(@__DIR__, ".."))
    mktempdir(prefix = "reactivekernels-fair-posteriordb-b3-") do environment
