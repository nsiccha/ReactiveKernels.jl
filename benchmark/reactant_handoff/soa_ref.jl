...
for (md,seed) in ((2,20260829),(4,20260829),(6,12345),(8,777))
    fn=frame(pf,Float64,md); Cn=RK.compile_nuts_native(pf,Fix.nuts_state,Fix.refresh_momentum!!,Fix.nuts!!,fn)
    fc=frame(pf,Float64,md); Cc=RK.compile_nuts(pf,Fix.nuts_state,Fix.refresh_momentum!!,Fix.nuts!!,fc)
